# PowerShell script to build Blackwood.Core library documentation with timeout protection

Write-Host "Building Blackwood.Core library documentation..." -ForegroundColor Green
