...
|--------------------------------------------------------------|------------------------------------------------|
| [Animation](xref:Blackwood.Animation)                        | Provides easing functions for animation curves. |
...
| [LinearInterpolate](xref:Blackwood.LinearInterpolate)        | Provides linear interpolation (lerp) functionality for various data types. |
...
| [PropertyInterpolator](xref:Blackwood.PropertyInterpolator)  | Creates interpolation functions for complex objects by analyzing their properties. |
